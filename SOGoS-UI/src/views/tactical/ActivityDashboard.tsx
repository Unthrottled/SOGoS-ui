...
const ActivityDashboard: FC<DispatchProp & Props> = ({
  ...
  const [tacticalActivityName, setTacticalActivityName] = useState(
    currentTacticalActivity.name,
  );
  ...
  const hideTacticalActivity = () => {
    dispatch(
      createHideTacticalActivityEvent(mappedTacticalActivities[activityId]),
    );
    history.goBack();
  };
  ...
  const unHideTacticalActivity = () => {
    dispatch(
      createShowTacticalActivityEvent(mappedTacticalActivities[activityId]),
    );
    history.goBack();
  };
  ...
  const wipeObjectiveOffOfTheFaceOfThePlanet = () => {
    dispatch(
      createRequestToDeleteTacticalActivityEvent(currentTacticalActivity),
    );
    history.goBack();
  };
  ...
  return (
    <LoggedInLayout>
      <div className={classes.headerContent}>
        <Container maxWidth={'sm'}>
          ...
          <Typography
            ...
            color="textSecondary"
            paragraph>
            This is something you spend your time on. Whether or not it helps
            you reach your goal is up to you. Remember spend your time wisely,
            because you aren't getting it back!
          </Typography>
        </Container>
      </div>
        ...
        <div className={classes.cardContent}>
          ...
          <TextField
            ...
            {...(currentTacticalActivity
              ? {defaultValue: currentTacticalActivity.name}
              : {})}
      ...
      <PopupModal
        ...
        contents={
          "Woah! Are you sure you want to delete this activity? You'll lose all history of what you have done!"
        }
      />
    </LoggedInLayout>
  );
