      ...
      <div className={classes.headerContent}>
        <Container maxWidth={'sm'}>
          ...
          <Typography
            ...
            color="textSecondary"
            paragraph>
            What does it mean to succeed? Figure out what you want to do and how
          ...
          <div className={classes.cardContent}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="textSecondary" component="p">
                Choose your <strong>Top 3</strong> goals. You can have up to 5,
                but limit it to what is important.
              </Typography>
            </CardContent>
          </div>
        </CardActionArea>
