...
export function* activityCreationSaga({payload}: PayloadEvent<TacticalActivity>) {
  yield call(activityAPIInteractionSaga, payload, activityCreateSaga, activityUploadToCached);
}

export function* activityChangesSaga({payload}: PayloadEvent<TacticalActivity>) {
...
export function* activityTerminationSaga({payload}: PayloadEvent<TacticalActivity>) {
...
export const activityUploadToCached: (tacticalActivity: TacticalActivity) => CachedTacticalActivity = activity => ({
  activity,
  uploadType: EventTypes.CREATED,
});

export const activityUpdateToCached: (tacticalActivity: TacticalActivity) => CachedTacticalActivity = activity => ({
  activity,
  uploadType: EventTypes.UPDATED,
});

export const activityDeleteToCached: (tacticalActivity: TacticalActivity) => CachedTacticalActivity = activity => ({
  activity,
  uploadType: EventTypes.DELETED,
});

export const activityCompleteToCached: (tacticalActivity: TacticalActivity) => CachedTacticalActivity = activity => ({
  activity,
...
export function* activityAPIInteractionSaga(activity: TacticalActivity,
                                            ...
                                            cachedTacticalActivityFunction:
                                              (tacticalActivity: TacticalActivity) => CachedTacticalActivity) {
