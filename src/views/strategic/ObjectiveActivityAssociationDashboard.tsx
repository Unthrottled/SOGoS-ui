...
export const createAssociationComponent = (
  rememberedObjective: Objective | null,
...
const ObjectiveActivityAssociationDashboard: FC = () => {
  const classes = useStyles();
  const {objectiveId} = useParams<{objectiveId: string}>();
  const {objectives, activities} = useSelector(mapStateToProps);
  ...
  const associatedActivityDictionary = reduceRight(
    rememberedObjective.associatedActivities || [],
  ...
  const selectedActivities = reduceRight(
      ...
      <div className={classes.root}>
        <ActivityList
          actionComponent={(tacticalActivity: TacticalActivity) => (
            <Switch
              checked={activitySwitches[tacticalActivity.id]}
...
export default ObjectiveActivityAssociationDashboard;
